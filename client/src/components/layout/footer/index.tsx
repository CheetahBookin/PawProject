    ...
    <footer className="px-3 pt-4 lg:px-9 border-t-2 bg-brand-primary">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col gap-2 text-sm">
          ...
          <p className="text-base font-bold tracking-wide text-gray-900">Social Media</p>
          <div className="flex items-center gap-2">
            <a href="https://github.com/CheetahBookin/PawProject" className="hover:text-brand-primary">
              <svg
